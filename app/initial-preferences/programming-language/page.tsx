...
export default function ProgrammingLanguage() {
  ...
  const saveSelection = () => {
    ...
    localStorage.setItem("programmingLanguages", JSON.stringify(selections));
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-grow flex items-center justify-center bg-custom-yellow">
        <PageTransition>
          <QuestionHeader title="¿Qué lenguajes de programación sabes?" description="Selecciona todos los que correspondan" />
