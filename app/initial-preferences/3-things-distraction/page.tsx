...
export default function ThreeThingsDistraction() {
  ...
  const currentPageIndex = pages.indexOf("/initial-preferences/3-things-distraction");
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-grow flex items-center justify-center bg-custom-yellow">
        <PageTransition>
          <QuestionHeader title="Questions for creating a user Profile" description="¿Cuáles son las 3 cosas más importantes que buscas a la hora de estudiar?" />
